...
var DEFAULT_URL =  APP_PDF.guiapostulante(); //"/inscripcion/postpago/guiapostulante";
...
PDFJS.workerSrc = '/vendor/pdf-flipbook/pdfjs/build/pdf.worker.js';
PDFJS.cMapUrl = '/pdf-flipbook/pdfjs/cmaps/';
...
function getPDFFileNameFromURL(url) {
 console.log("popopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopopo")
  var reURI = /^(?:([^:]+:)?\/\/[^\/]+)?([^?#]*)(\?[^#]*)?(#.*)?$/;
  ...
  console.log("2312312312312323982734983745938754837983475983798340938450938450398509345809")
