...
public class Scalr {
     ...
     * @param targetSize The target width and height (square) that you wish the
     * image to fit within.
     ...
     *
     * @param src The image that will be scaled.
     * @param resizeMode Used to indicate how imgscalr should calculate the
     * final target size for the image, either fitting the image to the given
     * width ({@link Mode#FIT_TO_WIDTH}) or fitting the image to the given
     * height ({@link Mode#FIT_TO_HEIGHT}). If {@link Mode#AUTOMATIC} is passed
     * in, imgscalr will calculate proportional dimensions for the scaled image
     * based on its orientation (landscape, square or portrait). Unless you have
     * very specific size requirements, most of the time you just want to use
     ...
     * @param params The parameters that will be swapped into all the place
     * holders in the original messages before being logged.
     *
